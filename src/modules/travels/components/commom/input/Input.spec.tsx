...
describe('Input Component', () => {
  it('deve renderizar corretamente o rótulo (labelText)', () => {
    ...
    const { getByText } = render(
      <Input labelText={labelText} placeholder="Insira seu nome" />,
    );
  ...
  it('deve renderizar corretamente o placeholder', () => {
    ...
    const { getByPlaceholderText } = render(
      <Input labelText="Email:" placeholder={placeholderText} />,
    );
  ...
  it('deve permitir a entrada de texto', () => {
    const { getByPlaceholderText } = render(
      <Input labelText="Nome:" placeholder="Insira seu nome" />,
    );
